...
Output: docs/analysis_runs/run_20260326_114955/comp_scan_v7_results.json
...
M = 20
T_DIAMOND = 1.0
MASTER_SEED = 77777  # distinct from all prior runs
METRICS = {
    "ppwave_quad": 5.0,
    "schwarzschild": 0.005,
}
...
RESULTS_FILE = RUN_DIR / "comp_scan_v7_results.json"
