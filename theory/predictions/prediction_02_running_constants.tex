...
The ratio $c_1/c_2 = -1/3 + 120(\xi-1/6)^2/13$ holds exactly only at $\mu = \Lambda$ (reducing to $-1/3$ at conformal coupling $\xi = 1/6$). At lower scales:
\begin{equation}
...
\begin{equation}
  f_4 = \int_0^\infty f(u)\,u\,du
\end{equation}
where $f$ is the cutoff function in the spectral action. The ratio $c_1/c_2 = -1/3 + 120(\xi-1/6)^2/13$ (which reduces to $-1/3$ at conformal coupling $\xi = 1/6$) is \emph{independent} of $f_4$, but the absolute scale of the running (and thus the constraint~\eqref{eq:constraint}) requires knowing $f_4$.
