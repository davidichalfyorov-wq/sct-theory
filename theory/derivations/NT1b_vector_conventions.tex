...
\title{\textbf{NT-1b Vector (Gauge Boson) Form Factors:\\[4pt]
       ...
       {\normalsize Literature Review --- Independent Cross-Verification}}
...
derivations are performed (those belong to the derivation stage).
...
This is the literature review for Phase~2 (vector), which will be critically
...
Phase~2 derivation of the vector (gauge boson) nonlocal
form factors:
