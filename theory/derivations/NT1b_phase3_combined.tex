...
\begin{center}
  \colorbox{verified!15}{\parbox{0.6\textwidth}{\centering
    ...
    \small six-stage review pipeline, 8-layer verification, 354/354 checks PASS
  }}
\end{center}
...
From NT-1b Phases 1 and 2 (each verified to $\geq 98\%$ confidence via the
8-layer pipeline), the individual spin-sector form factors are:
...
\begin{tabular}{lcc}
  ...
  2.5. Property fuzzing (hypothesis) & PASS & 304/304 \\
  3. Literature (CPR, Avramidi, Stelle) & PASS & 8/8 \\
  4. Independent dual derivation & PASS & 5/5 \\
  4.5. Triple CAS (Fraction, mpmath, SymPy) & PASS & 5/5 \\
