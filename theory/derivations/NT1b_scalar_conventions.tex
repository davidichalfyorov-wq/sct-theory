...
%%
%%  Literature review output for independent cross-verification.
...
\title{\textbf{NT-1b Scalar Form Factors:\\[4pt]
       ...
       {\normalsize Literature Review --- Independent Cross-Verification (v2)}}
...
no original derivations are performed (those belong to the derivation stage).
...
This is the literature review, which will be critically
reviewed before proceeding to the derivation stage.
...
\end{align}
This is the expression the derivation should expand and simplify.
...
For completeness (and as a cross-check tool for the derivation), we record
...
%%======================================================================
\section*{Summary of Benchmarks for the Derivation}
%%======================================================================

\noindent
The derivation must reproduce the following values from a first-principles
