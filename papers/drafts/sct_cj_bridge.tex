...
The result at $N = 3000$, $\varepsilon = 5$, $M = 20$
independent seeds is
\begin{equation}
  \frac{\CJ_{\mathrm{cross}}}{\CJ_{\mathrm{plus}}}
  = 1.17 \pm 0.09
  \qquad (t = 1.86,\; p = 0.08),
\end{equation}
consistent with unity at the $2\sigma$ level.  The two
...
$\CJ_{\mathrm{cross}}/\CJ_{\mathrm{plus}} = 1.17 \pm 0.09$
($p = 0.08$), consistent with unity.
\end{remark}
