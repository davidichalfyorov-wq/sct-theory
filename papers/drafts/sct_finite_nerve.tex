...
shared branching edge. This demonstrates that the particular chain-level coherence scheme
considered here is not canonically determined by the unordered simplex
data alone. We note that the abstract simplicial homology \emph{is}
an intrinsic invariant of the nerve; what fails is the existence of
a canonical \emph{chain-level} representative without an auxiliary
ordering or orientation choice. All results are formalized and
