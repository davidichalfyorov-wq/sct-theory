...
\begin{figure}[t]
  ...
  The potential vanishes at the origin ($V(0) = 0$), recovers Newton's law
...
\end{equation}
at $95\%$ confidence level.  This bound comes from the E\"ot-Wash torsion
balance experiment~\cite{Alfyorov:2026ss}, which constrains the Yukawa
modification of the Newtonian potential at sub-millimetre distances.  A
slightly weaker bound $\Lam > 2.38 \times 10^{-3}\;\mathrm{eV}$ is
obtained from the Cassini spacecraft time-delay measurement (PPN-1);
throughout this paper we adopt the tighter torsion-balance bound as the
primary constraint.  All post-Newtonian parameters satisfy
