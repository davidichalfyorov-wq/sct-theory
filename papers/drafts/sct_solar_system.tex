...
\hypersetup{
  ...
  pdfsubject={doi:10.22541/au.177524450.03515205/v1}
}
...
The bound is determined by the SM content at conformal coupling $\xi = 1/6$ and depends
...
\begin{enumerate}
  ...
  \item \emph{Mass ratio.} At minimal coupling $\xi = 0$:
    $m_2/m_0 = \sqrt{10/13} \approx 0.877$, fixed by the SM spectrum.
...
Newtonian potential~\eqref{eq:V} has its Yukawa
